...
def get_searchlight_RDMs(data_2d, centers, neighbors, events,
    ...
    print('printing SL rdm')
    print(SL_rdms.dissimilarities)
    return SL_rdms
...
def evaluate_models_searchlight(sl_RDM, models, eval_function, method='corr', theta=None, n_jobs=1):
    ...
    """
    print('SL_RDM')
    print(sl_RDM.dissimilarities)
    if np.sum(sl_RDM.dissimilarities) == 0:
        print('oh no')
